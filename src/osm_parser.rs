...
/// Wrapper around `parse_osm_data` that drops the OutlineSuppression return value.
/// osm-godot doesn't need outline suppression (Minecraft-specific feature).
pub fn parse_osm_data_no_outline(
    osm_data: OsmData,
    bbox: LLBBox,
    scale: f64,
    debug: bool,

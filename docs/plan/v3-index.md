...
| REQ-0003-004 | PRD-0003 §REQ-0003-004 | v3-internal-navigation §Step 1-4 | `master_scene_mounts_navigation_controller` + 导航面板 UI 测试 | overlay/HUD 节点断言 + 面板焦点 E2E | E2E `panel_centered=true`、`controls_disabled=true`、`route_ribbon_exists=true` | done |
| REQ-0003-005 | PRD-0003 §REQ-0003-005 | v3-internal-navigation §Step 1-4 | `navigation_guidance_does_not_use_markers_or_voice_prompts` | headless E2E 不报错 | 当前阶段暂缓语音播报，导航脚本不调用 `DisplayServer.tts_speak` | deferred |
